...
Encoding categorical attributes involves converting categorical data (text-based or non-numeric) into numerical format, which can be utilized by machine learning algorithms.  
Here are common techniques for encoding categorical attributes:  
