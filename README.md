...
3. <ins>Association Rule Mining</ins>: Association Rule Mining is a rule-based machine learning  method for
discovering frequently occurring patterns, correlations, or associations between variables in large databases.
